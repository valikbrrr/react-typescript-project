  ...
  return (
    <div className=" bg-black pt-16 px-10">
      ...
      <div className="h-[88px] w-[100%] flex justify-center">
        <button
          type="button"
          className="bg-gradient-to-l from-indigo-600 via-pink-500 via-80% to-red-400 hover:scale-110 text-white font-bold py-4 mt-8 px-4 rounded-3xl justify-center transition-all"
